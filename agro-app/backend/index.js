...
// // const newsRoutes = require('./routes/newsRoutes'); // Add news route
// // const weatherRoutes = require('./routes/weatherRoutes'); // add weather route
...
// // // MongoDB connection (make sure you set MONGO_URI in .env file)
// // mongoose
...
// // app.use('/api/news', newsRoutes);//News route
// // app.use('/api/weather', weatherRoutes); // weather api


// // // Error handling middlewarefhuIOFsh
